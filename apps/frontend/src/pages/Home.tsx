    ...
    return (
        <main>
            <section>
                ...
                <a href="/schedule" className="fixed md:block bottom-2 px-8 py-4 bg-green-600 text-white text-xl font-semibold rounded-lg shadow-lg hover:bg-green-700 transition duration-300">
                    Schedule a Meeting
                </a>
                </div>
            </section>
            <section className="max-w-4xl mx-auto md:my-16 px-6 py-12 bg-white md:rounded-3xl shadow-xl">
